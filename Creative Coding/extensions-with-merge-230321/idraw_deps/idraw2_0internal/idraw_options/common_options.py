...
def core_options(parser, config):
    ...
    options.add_option("--speed_pendown",\
                       ...
                       help="Maximum plotting speed, when pen is down (1-10000)")

    options.add_option("--speed_penup",\
                       type="int", action="store", dest="speed_penup", \
                       default=config["speed_penup"], \
                       help="Maximum transit speed, when pen is up (1-18000)")
    ...
    options.add_option("--plot_file",\
                       type="inkbool", action="store", dest="plot_file",\
                       default=config["plot_file"],\
                       help="Boolean: Plot to file ")
    return options
...
def core_mode_options(parser, config):
    ...
    options.add_option("--mode",\
                       ...
                       default="plot", \
                       help="Mode or GUI tab. One of: [plot, layers, home, align, toggle, manual"\
