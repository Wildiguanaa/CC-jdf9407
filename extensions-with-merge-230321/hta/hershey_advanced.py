...
class HersheyAdv(inkex.Effect):
    ...
    def __init__(self, params=None):
        ...
        self.version_string = "5.2.1" # Dated 2022-10-01
        self.text_delimiter = '🐈🐈🐈🐈🐈'
        self.text_empty = ''
        self.font_list = []
        self.line_offset = 0
    ...
    def recursively_traverse_svg(self, the_node_list, mat_current=None,
        ...
        for node in the_node_list:
            ...
            text_block = inkex.etree.SubElement(parent, 'g', g_attribs)
    ...
    def effect(self):
        ...
        self.warn_text_path = False    # For future use: Give warning about text attached to path.
